 ...
 *  description:- connect Nodes at Same level of BT (using level order traversal)
 *  TimeComplexity:- O(n)
**/
...
// connecting nodes function
void BinaryTree::connectNodes(struct Node *root) 
{ 
    // Base case 
    if (root == NULL) 
        return; 
...
int main(){
   ...
   while(1){
       cout<<"\nBinary Tree \n 1. insert \n 2. Display(levelorder) \n 3. connecting the nodes of tree \n 4. DeleteNode \n Press any key to Exit \n";
       cin>>i;
       switch (i)
       {
