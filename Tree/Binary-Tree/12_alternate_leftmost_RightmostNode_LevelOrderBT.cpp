 ...
 *  description:- alternate leftmost and rightmost node in levelorder of Binary Tree
**/
...
class BinaryTree {
    ...
    public:
        ...
        void alternateLeftmostRighmostLevelOrder(struct Node *root);
        

};


// alternate leftmost and rightmost node levelorder traversal of BT
void BinaryTree::alternateLeftmostRighmostLevelOrder(struct Node *root){
...
int main(){
   ...
   BinaryTree t;
   while(1){
       cout<<"\nBinary Tree \n 1. insert \n 2. Display(levelorder) \n 3. alternate leftmost & rightmost node in LevelOrder Trversal of tree \n 4. DeleteNode \n Press any key to Exit \n";
       cin>>i;
       switch (i)
       {
           ...
           case 3:  
                    ...
                    t.alternateLeftmostRighmostLevelOrder(root);
                    break;
