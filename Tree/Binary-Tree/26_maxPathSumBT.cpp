 ...
 *  description:- Max Path Sum of Binary Tree.
 *  TimeComplexity:- O(n)
**/
...
class BinaryTree {
    ...
    public:
        ...
        void maxPathSum(struct Node *root);
...
int maxPathSumUtil(struct Node *root, int &res){
    ...
    // l or r storing the max value while going through left and right child of root of tree
...
// Maximum Path Sum
void BinaryTree::maxPathSum(struct Node *root){
    int res = INT_MIN;
    maxPathSumUtil(root, res);
    cout<<"The Maximum Path Sum:- "<<res<<"\n";
}
